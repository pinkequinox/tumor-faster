...
class RPN(nn.Module):
    ...
    def __init__(self):
        ...
        self.score_conv = Conv2d(256, len(self.anchor_scales) * 3 * 2, 1, relu=False, same_padding=False)
        self.bbox_conv = Conv2d(256, len(self.anchor_scales) * 3 * 4, 1, relu=False, same_padding=False)
