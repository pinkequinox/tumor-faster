...
#    classes = np.asarray(['__background__',
 #                      '0', '1'])
    ...
    def __init__(self, classes=None, debug=False):
        ...
        self.layer4 = self.rpn.features.layer4
        self.avgpool = self.rpn.features.avgpool
        del self.rpn.features.layer4
        del self.rpn.features.avgpool
        del self.rpn.features.fc
